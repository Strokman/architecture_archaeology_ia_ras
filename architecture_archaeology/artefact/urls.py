...
from artefact.views import SubmitArtefactView, ListArtefactView, DetailArtefactView, UpdateArtefactView, DeleteArtefactView
...
urlpatterns = [
    ...
    path("delete/artefact/<slug:slug>", DeleteArtefactView.as_view(), name="delete"),
]
